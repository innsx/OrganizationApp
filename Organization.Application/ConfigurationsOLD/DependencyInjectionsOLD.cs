...
{
    public static class DependencyInjectionsOLD
    {
        public static IServiceCollection AddApplication(this IServiceCollection services)
        {
            ...
            services.AddMediatR(config =>
            {
                ...
                config.RegisterServicesFromAssembly(typeof(DependencyInjectionsOLD).Assembly);
            });
            ...
            services.AddValidatorsFromAssembly(typeof(DependencyInjectionsOLD).Assembly);
